...
export default function LoginPage() {
  ...
  const callbackUrl = searchParams.get("callbackUrl") || "/dashboard/supplier"
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <p className="text-center text-sm text-gray-500">
              ...
              <Link href="/auth/register/supplier" className="font-medium text-zanzibar-600 hover:text-zanzibar-700">
                Register
              </Link>
            </p>
          </form>
